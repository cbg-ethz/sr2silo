...
class FloydWarshall:
    ...
    def print_shortest_path(self,
        ...
        if not path:
            print(f"No path exists between {self.tree.labels[src_idx]} and {self.tree.labels[dst_idx]}")
            return
